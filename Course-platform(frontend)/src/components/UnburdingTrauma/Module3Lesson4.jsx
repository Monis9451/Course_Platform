  ...
  return (
    <div className="p-8">
      ...
      <div className="bg-white border border-gray-200 p-6 rounded-lg mb-8">
        ...
        <div className="bg-[#f8f0e6] rounded-lg p-6 flex items-center justify-center">
          <div className="text-center">
            <button className="h-20 w-20 bg-[#bd6334] rounded-full flex items-center justify-center mx-auto mb-4 hover:bg-[#a85629] transition-colors">
