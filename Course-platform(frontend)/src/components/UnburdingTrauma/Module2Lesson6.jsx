  ...
  return (
    <div className="p-8">
      ...
      <div className="border border-gray-200 rounded-md p-6 mb-8">
        ...
        <p className="mb-4">Below is a simple mindful movement sequence you can practice along with the video. Remember to move at your own pace and modify any movements as needed for your body.</p>
        ...
        <div>
          ...
          <textarea 
            ...
            rows={3}
            placeholder="What sensations did you notice during the movement practice? Were there parts of your body that felt more connected or distant? How does your body feel now compared to before you began?"
          ></textarea>
      ...
      <div className="bg-gradient-to-r from-[#fdf5e6] to-[#f8f0e6] p-6 rounded-lg mb-8 border border-[#e6d5c1]">
        ...
        <div className="mt-6 p-5 bg-white rounded-lg border border-gray-200">
          ...
          <ul className="space-y-2 pl-6 list-disc">
            <li>Does this practice make me feel safe and in control of my experience?</li>
            ...
            <li>Do I feel a sense of curiosity and interest in this practice?</li>
          </ul>
          
          <p className="italic mt-3">Remember: The best movement practice is one that you'll actually do regularly and that leaves you feeling more connected to your body afterward.</p>
        </div>
      </div>
      ...
      <div className="border border-gray-200 rounded-lg p-6">
        ...
        <div className="bg-[#f8f0e6] p-5 rounded-lg mb-6">
          ...
          <ul className="space-y-2 pl-6 list-disc">
            ...
            <li>Take 5 minutes each day for even a brief movement practice</li>
