      ...
      <div className="bg-white border border-gray-200 p-6 rounded-lg mb-8">
        ...
        <div className="relative">
          ...
          <div className="relative pl-10 pb-8">
            <div className="absolute left-1 w-6 h-6 rounded-full bg-[#bd6334] text-white flex items-center justify-center">1</div>
          ...
          <div className="relative pl-10 pb-8">
            <div className="absolute left-1 w-6 h-6 rounded-full bg-[#bd6334] text-white flex items-center justify-center">2</div>
          ...
          <div className="relative pl-10 pb-8">
            <div className="absolute left-1 w-6 h-6 rounded-full bg-[#bd6334] text-white flex items-center justify-center">3</div>
          ...
          <div className="relative pl-10 pb-8">
            <div className="absolute left-1 w-6 h-6 rounded-full bg-[#bd6334] text-white flex items-center justify-center">4</div>
          ...
          <div className="relative pl-10">
            <div className="absolute left-1 w-6 h-6 rounded-full bg-[#bd6334] text-white flex items-center justify-center">5</div>
