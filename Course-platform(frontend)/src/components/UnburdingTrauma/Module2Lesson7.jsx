    ...
    <div className="p-8">
      ...
      <div className="mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>Which areas of your body were easier to feel and connect with?</li>
          <li>Did you notice any areas of numbness or disconnection?</li>
          <li>How did your awareness shift during the practice?</li>
        </ul>
      </div>
      
      <div className="bg-[#f7f1e9] p-6 rounded-md mb-8">
        <p className="mb-4">Body awareness meditation (sometimes called a body scan) is a foundational practice for reconnecting with your physical self after trauma.</p>
        
        <p className="mb-4">This practice involves systematically bringing attention to different parts of your body, noticing sensations without trying to change them. It helps create a map of your internal landscape and builds your capacity to be present with bodily experience.</p>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-[#f8f0e6] p-5 rounded-lg">
            ...
            <p className="mb-3">Honor your needs by modifying the practice:</p>
            
            <ul className="space-y-2 pl-6 list-disc">
              <li>Skip areas of the body that feel too activating</li>
              <li>Keep eyes open if closing them feels unsafe</li>
              <li>Use shorter practice durations (even 5 minutes can be beneficial)</li>
      ...
      <div className="border border-gray-200 rounded-md p-6 mb-8">
        ...
        <div className="bg-white border border-gray-200 p-5 rounded-lg mb-6">
          <h4 className="font-medium mb-3 text-center">Body Awareness Meditation (10-15 minutes)</h4>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm">Begin to deepen your breath slightly, bringing more conscious movement into your body. Wiggle your fingers and toes if you like. When you're ready, if your eyes are closed, gently open them. Take a moment to notice how you feel after this practice.</p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <textarea 
            ...
            rows={3}
            placeholder="What sensations did you notice in different parts of your body? Were there areas that were easy to feel and areas that were more difficult to access? Did you notice any shifts in your awareness during the practice?"
          ></textarea>
      ...
      <div className="mb-8">
        ...
        <p className="mb-4">When beginning a body awareness practice after trauma, you may encounter various experiences. All of these are normal and part of the reconnection process:</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="bg-white border border-gray-200 p-5 rounded-lg">
            ...
            <p className="text-sm italic">This is a protective response that developed for good reason. Simply noting "I'm not feeling much here right now" is a form of awareness itself. With consistent practice, sensation often gradually returns.</p>
          </div>
          ...
          <div className="bg-white border border-gray-200 p-5 rounded-lg">
            ...
            <ul className="space-y-2 pl-6 list-disc mb-3">
              ...
              <li>Shifts in emotional state during the practice</li>
            </ul>
          ...
          <div className="bg-white border border-gray-200 p-5 rounded-lg">
            ...
            <p className="text-sm italic">This is your nervous system signaling that the current practice may be too intense. Try a shorter duration, keep eyes open, incorporate gentle movement, or focus only on safe body parts.</p>
          </div>
        ...
        <div className="bg-[#f8f0e6] p-6 rounded-lg">
          ...
          <p className="mb-3">Occasionally, body awareness practice may trigger traumatic memories or flashbacks. If this happens:</p>
          ...
          <ul className="space-y-2 pl-6 list-disc mb-4">
            ...
            <li>If needed, stop the practice and engage in a calming activity</li>
          </ul>
          
          <p className="italic">If you consistently experience flashbacks during body awareness practice, consider working with a trauma-informed therapist who can provide additional support and guidance.</p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-[#fdf5e6] to-[#f8f0e6] p-6 rounded-lg mb-8 border border-[#e6d5c1]">
        ...
        <p className="mb-4">While formal meditation practice is valuable, integrating body awareness into everyday activities can dramatically accelerate reconnection:</p>
