...
const Module5Lesson3 = () => {
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold text-[#bd6334] mb-6">Release as a Path to Freedom and Wholeness</h1>
      ...
      <div className="prose max-w-none">
        ...
        <h2 className="text-2xl font-semibold text-[#bd6334] mt-8 mb-4">Understanding Release as Liberation</h2>
        <p className="text-lg leading-relaxed mb-6">
        ...
        <div className="bg-blue-50 p-6 rounded-lg mb-6">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Honoring your growth by releasing old versions of yourself</li>
            <li>Choosing freedom over familiar patterns</li>
        ...
        <div className="bg-green-50 p-6 rounded-lg mb-6">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Renewed energy and vitality</li>
            <li>Enhanced creativity and inspiration</li>
            <li>Deeper connection to your authentic self</li>
            <li>Improved relationships and boundaries</li>
          </ul>
        </div>
        ...
        <p className="text-lg leading-relaxed mb-6">
          This integration process allows you to:
        </p>

        <ul className="list-disc list-inside space-y-2 mb-6">
          <li>Honor your journey without being defined by it</li>
          <li>Transform pain into compassion</li>
          <li>Use your experiences to help others</li>
          <li>Maintain healthy boundaries while staying open-hearted</li>
        ...
        <div className="bg-yellow-50 p-6 rounded-lg mb-6">
          ...
          <ol className="list-decimal list-inside space-y-3">
            ...
            <li><strong>Feel:</strong> Allow yourself to fully experience any emotions that arise around letting go</li>
            <li><strong>Breathe:</strong> Use breath to create space and flow through the release</li>
            <li><strong>Visualize:</strong> See yourself literally letting go—opening your hands, releasing balloons, etc.</li>
            <li><strong>Affirm:</strong> "I release what no longer serves me and open to my highest good"</li>
            <li><strong>Fill the space:</strong> Consciously invite in what you want to cultivate instead</li>
          </ol>
        </div>
        ...
        <div className="bg-purple-50 p-6 rounded-lg mb-6">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li><strong>Stretching:</strong> Focus on areas where you hold tension</li>
            <li><strong>Walking:</strong> Take mindful walks in nature while setting intention to release</li>
            <li><strong>Breathwork:</strong> Use breath patterns to move energy through your system</li>
          </ul>
        </div>
        ...
        <div className="bg-blue-50 p-6 rounded-lg mb-6">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li><strong>Evening Letting Go:</strong> Before sleep, consciously release the day's stress</li>
            <li><strong>Forgiveness Practice:</strong> Daily forgiveness of yourself and others</li>
            <li><strong>Gratitude for Lessons:</strong> Thank challenging experiences before releasing them</li>
          </ul>
        </div>
        ...
        <div className="bg-green-50 p-6 rounded-lg mb-6">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>A witnessing presence (yourself, trusted friend, or nature)</li>
            <li>A transformative action (burning, burying, washing away)</li>
            <li>Space for emotion and honoring</li>
            <li>Invitation of what you want to cultivate instead</li>
          </ul>
        </div>
