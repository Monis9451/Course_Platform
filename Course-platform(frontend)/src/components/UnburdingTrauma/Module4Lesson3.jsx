        ...
        <div className="bg-white border border-gray-200 p-6 rounded-lg">
          <div className="space-y-5">
            <div className="flex gap-4">
              <div className="h-8 w-8 rounded-full bg-[#bd6334] text-white flex items-center justify-center flex-shrink-0">1</div>
              <div>
            ...
            <div className="flex gap-4">
              <div className="h-8 w-8 rounded-full bg-[#bd6334] text-white flex items-center justify-center flex-shrink-0">2</div>
              <div>
            ...
            <div className="flex gap-4">
              <div className="h-8 w-8 rounded-full bg-[#bd6334] text-white flex items-center justify-center flex-shrink-0">3</div>
              <div>
            ...
            <div className="flex gap-4">
              <div className="h-8 w-8 rounded-full bg-[#bd6334] text-white flex items-center justify-center flex-shrink-0">4</div>
              <div>
            ...
            <div className="flex gap-4">
              <div className="h-8 w-8 rounded-full bg-[#bd6334] text-white flex items-center justify-center flex-shrink-0">5</div>
              <div>
